...
namespace PiratePanic.Content.Biomes
{
	...
	public class ExampleSurfaceBiome : ModBiome
	{
		...
		public override ModWaterStyle WaterStyle => 6; 
		public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => 4;
		...
		public override bool IsBiomeActive(Player player) 
        {
			...
			bool b3 = player.ZoneSkyHeight || player.ZoneRockLayerHeight;
			return b1 && b3;
		}
