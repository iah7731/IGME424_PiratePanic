...
{
	public class DaveEJonesDeckhand : ModNPC
	{
		...
		public override void SetDefaults() {
			...
			AIType = NPCID.PirateDeckhand; // Might end up despawning if there isn't a Pirate Invasion. Needs to be checked.
			AnimationType = NPCID.PirateDeckhand; 
			Banner = Item.NPCtoBanner(NPCID.PirateDeckhand);
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			...
			bestiaryEntry.Info.AddRange([
				...
				new FlavorTextBestiaryInfoElement("Dave E Jones Deckhand"),
			]);
		}
