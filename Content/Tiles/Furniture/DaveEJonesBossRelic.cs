...
namespace PiratePanic.Content.Tiles.Furniture
{
	public class DaveEJonesRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "PiratePanic/Content/Tiles/Furniture/DaveEJonesBossRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "PiratePanic/Content/Tiles/Furniture/RelicPedestal";
